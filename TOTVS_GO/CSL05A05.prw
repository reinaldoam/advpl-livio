...
//oBrowse:DisableDetails()
	...
	oBrowse:SetMenuDef( 'CSL05A05' ) // Define de que fonte virão os botoes deste browse
...
User Function 05A05EXC()
	...
	If !(lRet)
		...
		//Help('',1,"05A05EXC","","Diagnostico ("+Alltrim(cDiag)+") já foi utilizada. Não é permitido realizar a exclusão.",1,0)
		U_MsgHelp(,"Diagnostico ("+Alltrim(cDiag)+") já foi utilizada.", "Exclusão Não Permitida.")
	Else
		RecLock("ZB4",.F.) // Define que será realizada uma alteração no registro posicionado
